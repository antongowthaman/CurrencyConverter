...
const dataURL = "http://api.exchangeratesapi.io/v1/latest?access_key=ae2295a7e442e73946e7d468b0230a2f&format=1";

const initiallyDisplayedCurrencies = ["EUR", "USD", "GBP", "INR", "JPY"];
let baseCurrency;
